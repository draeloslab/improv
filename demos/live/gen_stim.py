...
x1 = np.linspace(0,330,num=12) #np.array([0, 45, 90, 135, 180, 225, 270, 315]) #np.linspace(0,350,num=15).astype(np.int)
x2 = np.array([0.02, 0.04, 0.06, 0.08, 0.10, 0.12]) #np.linspace(0,360,endpoint=False,num=24) 
