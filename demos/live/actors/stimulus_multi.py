...
class VisualStimulus(Actor):
    ...
    def __init__(self, *args, ip=None, port=None, seed=1234, stimuli = None, **kwargs):
        ...
        # FIXME: at some point we should make this more modular, so that we don't have to constantly define each parameter? 
        ...
        # This will come from BayesOpt parameters.yaml --> config.py
    ...
    def runStep(self):
        ...
        # logger.info('SELF.Q_IN: {}'.format(self.q_in.get(timeout=0.0001)))
        # logger.info('SELF.CLIENT: {}'.format(self.client.getList(self.q_in.get(timeout=0.0001))))
