...
class DimReduction(Actor):
    ...
    def setup(self):
        ...
        # smoothing params
        kern_sd = 50
        self.smooth_filt = signal.windows.gaussian(int(6 * kern_sd / bin_size_ms), int(kern_sd / bin_size_ms), sym=True)
    ...
    def runStep(self):
        ...
        try:
            ...
            data_curr = self.client.get(res)[1]
            self.t = self.client.get(res)[0]
